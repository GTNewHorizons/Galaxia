...
public final class GalaxiaGTAttachmentRegistration {
    ...
    private static void registerFluidHandlers() {
        StationAttachmentRegistry
            .register(MTEYottaFluidTank.class, new IFluidStorageHandler<MTEYottaFluidTank>() {
                ...
                public long getFluidStored(MTEYottaFluidTank attachment) {
                    return attachment.mStorageCurrent
        ...
        StationAttachmentRegistry
            .register(MTETankTFFT.class, new IFluidStorageHandler<MTETankTFFT>() {
