...
public final class AssetCreateRequestPacket implements IMessage {
    ...
    private void validateTargetBody(UUID teamId) {
        ...
        if (kind == CelestialAsset.Kind.SATELLITE && requiredSatelliteKind() == SatelliteKind.COMMUNICATION
            && body.id()
                .isMinorBody()) {
            throw new IllegalArgumentException(
                "Cannot create communication satellite on asteroid " + celestialObjectId);
        }
