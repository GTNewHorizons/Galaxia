...
public enum EnumTiers {
    ...
    TIER_1(1,
        ModuleLimit.of(RocketPartType.DECOUPLER, 1),
        ModuleLimit.of(RocketPartType.FUEL_TANK, 1),
        ModuleLimit.of(RocketPartType.FUNCTIONAL, 1),
        ModuleLimit.of(RocketPartType.ENGINE, 1),
        ModuleLimit.of(RocketPartType.STRUCTURAL, 0)
    ),

    TIER_2(2,
        ModuleLimit.of(RocketPartType.DECOUPLER, 1),
        ModuleLimit.of(RocketPartType.FUEL_TANK, 3),
        ModuleLimit.of(RocketPartType.FUNCTIONAL, 2),
        ModuleLimit.of(RocketPartType.ENGINE, 3),
