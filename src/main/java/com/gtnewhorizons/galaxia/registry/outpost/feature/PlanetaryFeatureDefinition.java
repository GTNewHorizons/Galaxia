...
@Builder
public record PlanetaryFeatureDefinition(
    PlanetaryFeatureKey key,
    String displayName,
    ResourceLocation texture,
    String description,
    PlanetaryFeatureLayer layer,
    PlanetaryFeaturePlacement placement) {
    ...
    public PlanetaryFeatureDefinition {
        ...
        if (displayName == null || displayName.isBlank()) {
            throw new IllegalArgumentException(
                "Planetary feature displayName must not be null or blank");
        }
        ...
        layer = layer == null
            ? PlanetaryFeatureLayer.RESOURCE
            : layer;

        placement = placement == null
            ? PlanetaryFeaturePlacement.patch(12.0, 4.0)
            : placement;
    }
