...
import com.gtnewhorizons.galaxia.registry.block.special.BlockModuleController;
...
public enum GalaxiaBlocksEnum {
    ...
    MODULE_CONTROLLER(new BlockModuleController(), TileModuleController.class, "module_controller"),
