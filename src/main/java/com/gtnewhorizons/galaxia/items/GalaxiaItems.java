...
import static com.gtnewhorizons.galaxia.items.GalaxiaItem.DEFAULT_ITEM_FACTORY;
...
public enum GalaxiaItems {
    ...
    GalaxiaItems(String registryName, int maxStackSize, Supplier<Item> itemFactory, Consumer<Item> recipeAdder) {
    ...
    GalaxiaItems(String registryName, Supplier<Item> itemFactory) {
        this(registryName, 64, itemFactory, null);
    }

    GalaxiaItems(String registryName, Supplier<Item> itemFactory, Consumer<Item> recipeAdder) {
        this(registryName, 64, itemFactory, recipeAdder);
    }

    GalaxiaItems(String registryName) {
