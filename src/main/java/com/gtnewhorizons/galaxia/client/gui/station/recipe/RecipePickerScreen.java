...
public final class RecipePickerScreen implements IGuiHolder<GuiData> {

    public static final SimpleGuiFactory FACTORY = new SimpleGuiFactory(
        "galaxia_recipe_picker",
        RecipePickerScreen::new);
    ...
    public ModularPanel buildUI(GuiData guiData, PanelSyncManager syncManager, UISettings settings) {
        ...
        Collection<GTRecipe> allRecipes = recipeModule.getRecipeMap()
            .getAllRecipes();
        ...
        GTRecipeMapId mapId = GTRecipeMapId.fromRecipeMapName(recipeModule.getRecipeMap().unlocalizedName);
        if (mapId == null) {
            panel.child(
